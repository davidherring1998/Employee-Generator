...
function generateManager (answers1, answers2, answers3,answers4) {
    const generateHTML = () =>
    `<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Office Number:${answers2.officeNum}</li>
    </ul>
  </div>   
  ...
  <div class="engineer-card" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item">ID:${answers2.id}</li>
      <li class="list-group-item">Email: <a href="mailto:${answers2.email}">${answers2.email}</a></li>
